...
|     |     |
| --- | --- |
**Source Horizontal Coordinate System** |New York State Plane Coordinates, Long Island East Zone, NAD83, US foot ([epsg:2263](https://spatialreference.org/ref/epsg/2263/)); Vertical Datum NAVD 1988
**Resolution** |NA
...
| DEMOLITION_YEAR | DEMOL_YR | The year the building was demolished. | number | |
| ALTERATION_YEAR (not published) |  | The year the building was significantly altered changing use, egress, or occupancy | number | |
...
| Shape__Area <br> SHAPE_AREA | varies | Do not use. This value is auto-generated by the system in [Web Mercator](https://spatialreference.org/ref/epsg/3857/) which is not area preserving. | number | Do not use |
| Shape__Length | varies | Do not use. This value is auto-generated by the system in [Web Mercator](https://spatialreference.org/ref/epsg/3857/) which is not length preserving. | number | Do not use |
