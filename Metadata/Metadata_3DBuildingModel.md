...
**Available Formats** |3-D Model data is available in the following formats: <br> [CityGML](http://maps.nyc.gov/download/3dmodel/DA_WISE_GML.zip)<br>[Multipatch](http://maps.nyc.gov/download/3dmodel/DA_WISE_Multipatch.zip)
