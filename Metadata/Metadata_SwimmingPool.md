# Swimming Pool
Filename: SWIMMING_POOL<br>Geometry Type: polygon<br><br>![image](https://github.com/CityOfNewYork/nyc-planimetrics/raw/master/Images/FeatureViews/Swimming_Pool.png)
...
**Description** |This feature class contains all in-ground swimming pools, regardless of shape, on the inside (water) of the pool.
...
**Available Formats** |File Geodatabase Feature Class as part of the Planimetrics geodatabase and individual shapefile on the [NYC Open Data Portal](https://data.cityofnewyork.us/City-Government/Swimming-Pools/j7ww-5ipv)
...
**Links** |https://data.cityofnewyork.us/City-Government/Swimming-Pools/j7ww-5ipv
**Tags** |structure, Planimetric, Swimming Pool, In-Ground Swimming Pool, Basemap, imageryBaseMapsEarthCover, Landbase, Pool, transportation, NYCMap
