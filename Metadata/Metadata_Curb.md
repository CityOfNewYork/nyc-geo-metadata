# Curb
Filename: CURB<br>Geometry Type: polyline<br><br>![image](https://github.com/CityOfNewYork/nyc-planimetrics/blob/master/Images/FeatureViews/Curb.png)
...
**Description** |Curbs are represented by segments between pavement and other surfaces. A curb feature is captured where it exists for the streets within ROW only. 
...
**Available Formats** |File Geodatabase Feature Class as part of the Planimetrics geodatabase and individual shapefile on the [NYC Open Data Portal](https://data.cityofnewyork.us/dataset/Curbs/ikvd-dex8)
...
**Links** |https://data.cityofnewyork.us/dataset/Curbs/ikvd-dex8
**Tags** |curb, gis, doitt
...
| FEATURE_CODE | Type of feature. 2250 = Curb | integer | No
| SUB_FEATURE_CODE | Sub feature code. 225000 = Curb | integer | No
