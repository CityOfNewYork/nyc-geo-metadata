...
| Area <br> Shape__Area <br> SHAPE_AREA <br> shape_area | varies | Do not use. This value is auto-generated by the system in [Web Mercator](https://spatialreference.org/ref/epsg/3857/) which is not area preserving. | number | Do not use |
| Length <br> Shape__Length <br> SHAPE_LENGTH <br> shape_length | varies | Do not use. This value is auto-generated by the system in [Web Mercator](https://spatialreference.org/ref/epsg/3857/) which is not length preserving. | number | Do not use |
