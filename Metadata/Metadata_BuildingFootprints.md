...
**Description** |This feature class contains building footprints. Each footprint represents the perimenter extent of the building. For more information on Building Footprints related to the planimetric update, see [Capture Rules.](https://github.com/CityOfNewYork/nyc-planimetrics/blob/master/Capture_Rules.md#building-footprint)
**Source(s)** |Current Imagery
**Publication Dates** |**Data**: 05/03/16<br>**Last Update**: Monthly <br>**Metadata**: 12/02/16<br>**Update Frequency**: Agency data is updated daily by Centerline Management Group (CMG). Public releases of this data are made Monthly
