...
**Publication Dates** |**Data**: 05/03/16<br>**Last Update**: 11/27/16<br>**Metadata**: 12/02/16<br>**Update Frequency**: 
...
**Contact Information** |**Name**: Colin Reilly, Director GIS Division, Department of Information Technology and Telecommunication (DOITT)<br>**Phone**: 718-403-8394<br>**Email**: spatialdatarequest@doitt.nyc.gov
...
| GROUND_ELEVATION | Lowest Elevation at the building ground level. Calculated from LiDAR or photogrammetrically using the methodology outlined below.
