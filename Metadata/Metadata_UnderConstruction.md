# Under Construction
Filename: Under Construction<br>Geometry Type: polygon<br><br>![image](https://github.com/CityOfNewYork/nyc-planimetrics/raw/master/Images/FeatureViews/Unk_Construction.png)
...
**Description** |This feature class includes all areas under construction (excavation) or deposits of material (storage) at their outer boundary.
**Source(s)** |Current imagery and previous planimetric database
**Publication Dates** |**Data**: 03/10/16<br>**Last Update**: <br>**Metadata**: 12/02/16<br>**Update Frequency**: As needed
**Available Formats** |File Geodatabase Feature Class as part of the Planimetrics geodatabase and individual shapefile on the [NYC Open Data Portal](Could not find on OpenData Portal)
...
**Links** |Could not find on OpenData Portal
**Tags** |
