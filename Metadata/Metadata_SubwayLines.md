# Subway Lines
Filename: <br>Geometry Type: polyline<br><br>![image]()
...
**Description** |Polyline representing NYC Transit Subway Lines.
**Source(s)** |Metropolitain Transit Authority (MTA) 
**Publication Dates** |**Data**: <br>**Last Update**: 1/4/2017<br>**Metadata**: 1/5/2017<br>**Update Frequency**: As needed
...
**Positional Accuracy** |Position of subway lines are approximate. 
**Features Captured** |
**Features Excluded** |Proposed or features that are under construction are not included in the dataset. 
**Capture and Update Notes** |Subway lines are optimized for cartography and based on information from MTA's website. 
