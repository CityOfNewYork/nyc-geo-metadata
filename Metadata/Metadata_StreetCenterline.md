...
**Contact Information** |**Name**: Michelle McInnes, Geographic Systems User Liason, Department of City Planning (DCP)<br>**Phone**: 212-720-3540<br>**Email**: mmcinne@planning.nyc.gov
...
| R_ZIP | Five-digit postal zip code for the right side of the street segment, relative to the digitized direction of the segment. |  | No
| L_ZIP | Five-digit postal zip code for the left side of the street segment, relative to the digitized direction of the segment. |  | No
| ST_NAME | Street Name added for cartographic labeling purposes. |  | No
...
| BIKE_LANE | Defines which segments are part of the bicycle network as defined by the NYC Department of Transportation. <br>1 = Class I <br>2 = Class II <br>3 = Class III <br>4 = Links <br>5 = Class I, II <br>6 = Class II, III <br>7 = Stairs <br>8 = Class I, III <br>9 = Class II, I <br>10 = Class III, I <br>11 = Class III, II |  | No
