...
| BIKE_TRAFDIR | Traffic Direction for bicycle travel. Code indicating the flow of traffic relative to the street segment's address range.<br>FT = With<br><br>TF = Against<br>TW = Two-Way<br>NV = Non-Vehicular | text | 
